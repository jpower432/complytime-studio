...
|:--|:--|:--|:--|
| **Data Platform** | Headless data API: evidence CRUD, certifier pipeline, posture computation, content ingestion, auth | Go gateway (`cmd/gateway`), PostgreSQL, NATS | [complytime-studio](https://github.com/complytime/complytime-studio) |
...
- Certifier pipeline (NATS-driven)
