...
### Requirement: Checkpoint summary injection
**Reason**: Checkpoints are removed. Server-side taskId persistence means the agent retains context natively via the A2A task.
**Migration**: No migration needed. Sticky notes remain for user-curated persistent context.
