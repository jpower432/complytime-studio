...
// Package identity defines shared user and role types consumed by both auth
// and store packages. It exists as a leaf package to avoid a circular
// dependency between internal/auth and internal/store.
package identity
